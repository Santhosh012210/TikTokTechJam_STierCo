"""KuaiRand-Pure baselines.
  ...
  --model fm    : Factorization Machine (starting model for participants to improve)
  --model random: random scores (lower bound and evaluation-code sanity check)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--data_dir', default='./KuaiRand-Pure/data',
                    help='data directory inside the extracted KuaiRand-Pure dataset')
