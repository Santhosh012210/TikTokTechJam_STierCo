...
offline, so it can be exercised from the CLI with no API key and no cost:
    ...
    python -m research_agent.knowledge "pairwise ranking loss gradient"
"""
...
from research_agent.knowledge.index import get_index
...
# ---------------------------------------------------------------------------
# Tool schema (canonical format; harness/provider.py converts to vendor format)
# ---------------------------------------------------------------------------
#
