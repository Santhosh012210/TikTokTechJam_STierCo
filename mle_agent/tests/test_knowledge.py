...
No API key, no network, no dataset. Run either way:
    ...
    python -m mle_agent.tests.test_knowledge
"""
import sys
...
from mle_agent.research_agent.knowledge import list_methods, search_ml_literature
from mle_agent.research_agent.knowledge.index import CORPUS_DIR, build_index, parse_document
